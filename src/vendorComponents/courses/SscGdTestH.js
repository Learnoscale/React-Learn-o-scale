...
import './SscChsl.css'
 ...
 export default function SscGdTestH() {
      ...
      <div className="align-items-center justify-content-center">
        <div className="about-content col-lg-12">
          <h1 className="text-white" id="pname">
            SSC GD Online Test Series -Hindi
          </h1>
    ...
    <div className="col-md-12 col-sm-12 col-xs-12">
      <div className="col-sm-12 col-md-5 col-xs-12 col-lg-5">
        <img
          ...
          src="https://soe-buck-lb.storage.googleapis.com/tempFile/sscgdhindi.jpg"
      ...
      <div className="col-sm-12 col-md-7 col-xs-12 col-lg-7">
        <h3 className="mainhead">SSC GD Online Test Series -Hindi</h3>
        ...
        <p className="showshopstyle5">
          SSC Constable GD Hindi is a wonderful opportunity for you to turn your
          dreams into reality! Get all information about SSC Constable GD Hindi
          - syllabus, preparation test, apply form, exam dates, admit card,
          latest exam pattern online test series and results here. Kick start
      ...
      <table className="table table-bordered table-hover">
        <tbody>
          ...
          <tr>
            ...
            <td className="showshopstyle6">SSC Hindi 01</td>
            <td style={{ textAlign: "center" }}>
              <a href="/generalTestInstruction/?e=5H4t52UbBdjLRaQ1VYl9tQahVm97m9fh">
                <button
              ...
              <div className="test-area-info">
                <ul className="list-group list-group-flush text-center showshopstyle2">
                  <li className="list-group-item showshopstyle4">
                    ...
                    <p>
                      <strong>20+ Full Mock Test</strong>
                    </p>
                    <p>
                      <strong>28 Subject-wise Test</strong>
                    </p>
                    <p>
                      <strong>50+ Topic-wise Test</strong>
                    </p>
                    <p />
                  </li>
                </ul>
            ...
            <div className="test-area-content">
              <div className="conta">
                ...
                <div className="content" id="home_quicklinks">
                  ...
                  <a className="quicklink link1" href="aa" aria-label="Discount">
                    <span className="ql_caption">
                      {" "}
                      <span className="outer">
                        <span className="inner">
              ...
              <div className="test-area-info">
                <ul className="list-group list-group-flush text-center showshopstyle2">
                  <li className="list-group-item showshopstyle4">
                    <p className="testpara showshopstyle13" />
                    <p>10 Full Mock Test</p>
                    <p>14 Subject wise Test</p>
                    <p />
                  </li>
                </ul>
              </div>
            ...
            <div className="test-area-content">
              <div className="conta">
                ...
                <div className="content" id="home_quicklinks">
                  ...
                  <a className="quicklink link1" href="ae" aria-label="Discount">
                    <span className="ql_caption">
                      {" "}
                      <span className="outer">
                        <span className="inner">
  ...
  <div className="container-fluid contentmatter">
    <div className="row">
      <div className="col-sm-12">
        ...
        <hr />
        <p>
          <strong>General Intelligence &amp; Reasoning:</strong>
          <br />
          Analogies, Similarities and Differences, Spatial Visualization,
          Spatial Orientation, Visual Memory, Blood Relation, Discrimination,
          Alphabet or Word Test, Syllogism, Observation, Relationship Concepts,
          Ordering and Ranking, Arithmetical Reasoning and Figural
          Classification, Arithmetic Number Series, Puzzles, Direction and
          Distances, Non-Verbal/ Verbal Series, Coding and Decoding, Clock and
          Calendar, Venn Diagram.
          <br />
          <strong>General Knowledge and General Awareness:</strong>
          <br />
          Sports, History, Culture, Geography, Economic Scene, General Polity,
          Indian Constitution, Scientific Research, Current Affairs, Static GK.
          <br />
          <strong>Elementary Mathematics:</strong>
          <br />
          ...
          Percentages, Simplification, Ratio and Proportion, Averages, Interest,
          Profit and Loss, Discount, Mensuration, Speed, Time and Distance,
          Ratio and Time, Time and Work, Mixture problem, Algebra, Data
          Interpretation,&nbsp;
          <br />
          <strong>Hindi:</strong>
          <br />
          वर्तनी की सामान्य अशुद्धियाँ तथा शब्दों के शब्द &nbsp;रूप, शब्दों के
          स्त्रीलिंग, बहुवचन, किसी वाक्य को अन्य लिंग में परिवर्तन, मुहावरा व
          उनका अर्थ, अशुद्ध वाक्यों के शुद्ध रूप, विलोमार्थी शब्द, समानार्थी व
          पर्यायवाची शब्द, अनेक शब्दों के लिए एक शब्द, कहावतें व लोकोक्तियां के
          अर्थ, संधि विच्छेद, क्रिया से भाववाचक संज्ञा बनाना, रचना एवं रचयिता
        </p>
      </div>
    </div>
  </div>
        ...
        <div className="container-fluid">
          ...
          <form id="feedback" action="/category/feedback" method="post">
            ...
            <input
              ...
              type="hidden"
            />
            <input id="id" name="id" defaultValue={28} type="hidden" />
            <input
              id="constructedUrl"
              name="constructedUrl"
              defaultValue="ssc-gd-hindi"
              type="hidden"
            />
            ...
            <div>
              <input
                type="hidden"
                name="_csrf"
                defaultValue="275458a3-f16a-49f2-9af1-ffa48961835c"
              />
            </div>
          </form>
        </div>
