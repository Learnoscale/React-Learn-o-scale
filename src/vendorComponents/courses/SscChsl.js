...
import './SscChsl.css'
 ...
 export default function SscChsl() {
    ...
    <div className="col-md-12 col-sm-12 col-xs-12">
      <div className="col-sm-12 col-md-5 col-xs-12 col-lg-5">
        <img
          ...
          src="https://soe-buck-lb.storage.googleapis.com/tempFile/sscchsl.jpg"
      ...
      <div className="col-sm-12 col-md-7 col-xs-12 col-lg-7">
        <h3 className="mainhead">SSC CHSL Online Test Series</h3>
        ...
        <p className="showshopstyle5">
          Staff Selection Commission operated under the government of India. SSC
          CGL commission has attached office of the Department of Personnel and
          Training which consists of Chairman, two Members and a
          Secretary-cum-Controller of Examinations. His post is equivalent to
          the level of Additional Secretary to the Government of India. It has
          its headquarters located at New Delhi. Seven regional offices are
          there at in present located at Guwahati, Banglore, Chennai, Allahabad,
          kolkata and Mumbai. It also has two Sub- Regional offices at Raipur
          and Chandigarh.
        </p>
      </div>
      <p>&nbsp;</p>
      <table className="table table-bordered table-hover">
        <tbody>
          ...
          <tr>
            ...
            <td className="showshopstyle6">SSC CHSL 02</td>
            <td style={{ textAlign: "center" }}>
              <a href="/generalTestInstruction/?e=mQJervqoXmfp7LZqhm5THA==">
                <button
        ...
        <div className="container-fluid">
          ...
          <form id="feedback" action="/category/feedback" method="post">
            ...
            <input
              ...
              type="hidden"
            />
            <input id="id" name="id" defaultValue={12} type="hidden" />
            <input
              id="constructedUrl"
              name="constructedUrl"
              defaultValue="ssc-chsl-booster"
              type="hidden"
            />
            ...
            <div>
              <input
                type="hidden"
                name="_csrf"
                defaultValue="6d844dce-7ae2-4fc4-b541-687d9052aaca"
              />
            </div>
          </form>
        </div>
