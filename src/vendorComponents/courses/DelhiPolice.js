...
import './DelhiPolice.css'
 ...
 export default function DelhiPolice() {
    ...
    <div className="col-md-12 col-sm-12 col-xs-12">
      <div className="col-sm-12 col-md-5 col-xs-12 col-lg-5">
        <img
          ...
          src="https://soe-buck-lb.storage.googleapis.com/tempFile/delhipolice.jpg"
      ...
      <div className="col-sm-12 col-md-7 col-xs-12 col-lg-7">
        <h3 className="mainhead">Delhi Police Constable Online Test Series</h3>
        ...
        <p className="showshopstyle5">
          Delhi Police (DP) has its origin in a small security force. Delhi
          Police Headquaters are located at Indraprashta Estate, New Delhi. The
          DP is the Law enforcement agency for the National Capital Territory of
          Delhi. Delhi police is considered as the most advanced administrative
          system in India. DP is divided into twelve branches under the
          Commissioner of Delhi Police or CP. The main four among the branches,
          each under a Special Commissioner of Police.
        </p>
      </div>
      <p>&nbsp;</p>
      <table className="table table-bordered table-hover">
        <tbody>
          ...
          <tr>
            ...
            <td className="showshopstyle6">Common Mock 01</td>
            <td style={{ textAlign: "center" }}>
              <a href="/generalTestInstruction/?e=B238fMhZYweAGY2Nu3iSbDCmpgPnukWQKpAzxILmR4o=">
                <button
              ...
              <div className="test-area-info">
                <ul className="list-group list-group-flush text-center showshopstyle2">
                  <li className="list-group-item showshopstyle4">
                    ...
                    <p>
                      <strong>100+</strong>&nbsp;Total Test (Topic Wise +
                      Subject Wsie + Mock Test)
                    </p>
                    <p />
                  </li>
                </ul>
  ...
  <div className="container-fluid contentmatter">
    <div className="row">
      <div className="col-sm-12">
        ...
        <p>
          Alphabetical Order, Analogy or Similarity, Arrangement of words in
          order, Blood Relationship, Classification, Code- Decode, Coded Series,
          Data Sufficiency, Decision Making, Direction Sense, Distance &amp;
          Direction, Equality &amp; Inequality, Finding the Missing Number,
          Input -Output, Numerical Symbol Operations, Puzzles, Scheduled Time,
          Date, Day &amp; Year, Sitting Arrangement, Syllogism, Statement and
          Conclusions, Symbols and Notations, Word Formation
        </p>
        <p>
          <strong>Mathematics :</strong>
        </p>
        <p>
          Algebra, Average, Compound Proportion, Co-ordinate Geometry, Decimal
          Fractions, Geometry, Height &amp; Distance, LCM &amp; HCF, Line
          Graphs, Mensuration &amp; Area, Number Series, Number System,
          Partnership, Percentage, PIE Chart, Problems on Ages, Problems on
          Trains, Profit, Loss and Discount, Ratio &amp; Proportion, Simple
          &amp; Compound Interest, Simplification, Square &amp; Cube Root,
    ...
    <div className="row">
      ...
      >
        <div className="container-fluid">
          ...
          <form id="feedback" action="/category/feedback" method="post" style={{width:'100%'}}>
            <br />
            <br />
            <p style={{ fontSize: 18 }}>
            ...
            <input
              ...
              type="hidden"
            />
            <input id="id" name="id" defaultValue={5} type="hidden" />
            <input
              id="constructedUrl"
              name="constructedUrl"
              defaultValue="delhi-police-booster"
              type="hidden"
            />
            ...
            <div>
              <input
                type="hidden"
                name="_csrf"
                defaultValue="e5b055a8-68c1-4969-9076-24bfddf014a9"
              />
            </div>
          </form>
        </div>
