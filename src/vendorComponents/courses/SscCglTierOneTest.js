      ...
      <div className="align-items-center justify-content-center">
        <div className="about-content col-lg-12">
          <h1 className="text-white" id="pname">
            SSC CGL Tier-1 Online Test Series
          </h1>
    ...
    <div className="col-md-12 col-sm-12 col-xs-12">
      <div className="col-sm-12 col-md-5 col-xs-12 col-lg-5">
        <img
          ...
          src="https://soe-buck-lb.storage.googleapis.com/tempFile/ssccgl.jpg"
      ...
      <div className="col-sm-12 col-md-7 col-xs-12 col-lg-7">
        <h3 className="mainhead">SSC CGL Tier-1 Online Test Series</h3>
        ...
        <p className="showshopstyle5">
          SSC CGL is Staff selection Combined Graduate Level Examination, SSC
          CGL is an examination conduct for the various posts in ministries,
          departments and organizations of the Govt of India. It's conducted by
          the Staff Selection Commission (SSC) for selecting staff for various
          Group C and Group B posts. The Staff Selection Commission was
          established in 1975. Tier I consist writing objective multiple choice
          exam. Tier 1 covering subjects general intelligence and reasoning ,
      ...
      <table className="table table-bordered table-hover">
        <tbody>
          ...
          <tr>
            ...
            <td className="showshopstyle6">SSC Mock 03</td>
            <td style={{ textAlign: "center" }}>
              <a href="/generalTestInstruction/?e=H3v9Hqgc0tHNlO418hnvHg==">
                <button
            ...
            <div className="test-area-content">
              <div className="conta">
                ...
                <div className="content" id="home_quicklinks">
                  ...
                  <a className="quicklink link1" href="dd" aria-label="Discount">
              ...
              <div className="test-area-info">
                <ul className="list-group list-group-flush text-center showshopstyle2">
                  <li className="list-group-item showshopstyle4">
                    ...
                    <p>
                      120+ Total Test (Topic Wise + Subject Wsie + Mock Test)
                    </p>
                    <p />
                  </li>
                </ul>
  ...
  <div className="container-fluid contentmatter">
    <div className="row">
      <div className="col-sm-12">
        ...
        <p>
          Alphabetical Order, Analogy or Similarity, Arithmetical Problems,
          Arrangement of words in order, Blood Relationship, Classification,
          Code- Decode, Coded Series, Cubes &amp; Dices, Data Sufficiency,
          Decision Making, Direction Sense, Distance &amp; Direction, Equality
          &amp; Inequality, Finding the Missing Number, Input -Output, Numerical
          Symbol Operations, Puzzles, Scheduled Time, Date, Day &amp; Year,
          Sitting Arrangement, Syllogism, Statement and Conclusions, Symbols and
          Notations, Venn Diagram, Word Formation
        </p>
        <p>
        ...
        <p>
          ...
          Calendar, Clocks, Compound Proportion, Co-ordinate Geometry, Decimal
          Fractions, Geometry, Graphic Representation of Straight Lines, Height
          &amp; Distance, LCM &amp; HCF, Line Graphs, Logarithms, Mensuration
          &amp; Area, Mixture Alligation, Number Series, Number System,
          Partnership, Percentage, PIE Chart, Pipe &amp; Cisterns, Premutations
          &amp; Combinations, Prism &amp; Pyramid, Probability, Problems on
          Ages, Problems on Trains, Profit, Loss and Discount, Races, Ratio
          &amp; Proportion, Shares &amp; Dividend, Simple &amp; Compound
          Interest, Simplification, Square &amp; Cube Root, Surds and Indices,
          Tabulation (DI), Time &amp; Distance, Time &amp; Work, Trigonometry,
          True Discount
        </p>
        <p>
        ...
        <p>
          Active and Passive Voice, Adjectives (Determiners), Adverbs, Antonyms,
          Appropriate Words, Cloze Test (Comprehension), Comprehension Passage,
          Conjunctions, Direct-Indirect, Fill in the Blanks, Idioms and Phrases,
          Noun, One Word Substitution, Preposition, Pronoun, Rearrangement of
          Jumble Words in Sentences, Rearrangement of Jumbled Sentences in
          Paragraphs, Sentence Completion, Sentence Improvement, Spelling Test,
          Spotting Errors, Synonyms, Tense, Test of Analogy, Word Pairs Having
          Relationships, Word Utilization Problems
        </p>
        <p>
          <strong>General Knowledge :</strong>
        </p>
        <p>
          Bauddh &amp; Jain Relligion, Books &amp; Authors, Days &amp; Years,
          Economy, Famous Personalities, Famous Places in India, Geography -
          India, Geography - Physical, Geography - World, Gupt Samrajya, History
          - Medieval, History - Modern, Honours &amp; Awards, Indian Culture,
          Indian Dance &amp; Songs, Indian Economy, Indian Politics, Inventions,
          Mahajanpad Kal and Magadh Samrajya, Maruottar Bharat, Mourya Kal,
          Mugal Kal, Science &amp; Technology, Sindhu Sabhyata &amp; Ancient
          History, Sports, Vaidik Culture, World Organisations
        </p>
        <p>
          <strong>General Science :</strong>
        </p>
        <p>
          Science - Biology, Science - Chemistry, Science - Physics , Science -
          General
        </p>
      </div>
    </div>
        ...
        <div className="container-fluid">
                ...
                <div className="row">
                  <div className="col-lg-3 col-xs-12">
                    ...
                    <div className="review-block-name">
                      <a href="dd" aria-label="feedback List">
                        Gargi
                      </a>
                    </div>
                  </div>
                  <div className="col-lg-9 col-xs-12">
                    ...
                    <div className="review-block-description">
                      <p style={{ marginBottom: 3 }}>
                        i used this RRB Group D Online Test series for my exam.
                        i having a best user experience so i recommend you this
                        RRB Group D Online Test Series for exam preparation. its
                        offer quality questions according to exam syllabus with
                        reasonable price.
                      </p>
          ...
          <form id="feedback" action="/category/feedback" method="post">
            ...
            <input
              ...
              type="hidden"
            />
            <input id="id" name="id" defaultValue={2} type="hidden" />
            <input
              id="constructedUrl"
              name="constructedUrl"
              defaultValue="ssc-cgl-l-1-booster"
              type="hidden"
            />
            ...
            <div>
              <input
                type="hidden"
                name="_csrf"
                defaultValue="ad2690e8-eefd-44c4-aa41-14583c82a1fc"
              />
            </div>
          </form>
        </div>
