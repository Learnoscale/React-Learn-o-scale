...
return(
  ...
  <div className="container-fluid">
    ...
    <div className="col-12 py-4" style={{ width: '100%', height: '440px', overflow: 'auto'}} >  </div>
    <div className="row px-1 bg-white border" style={{ position: 'fixed',bottom: '10px', width: '100%'}}>
       <div className="col-2"></div>
       <div className="col-8 text-center"><button type="button" className="btn  btn-outline-danger px-4 fs-6 " onClick={() => navigate.push('/Ex-summary5')}>Skip</button></div>
        <div className="col-2"></div>
    </div>
