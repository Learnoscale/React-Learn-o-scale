...
return(
  ...
  <div className="container-fluid">
    ...
    <div className="row border">
      ...
      <div className="row border px-0 ">
      <div className="col-2"><small>Sections</small></div>
      <div className="col-7"></div>
      
      <div className="col-2"><text>Time Left:</text></div>
      <div className="col-1"><CountDownTimer hoursMinSecs={hoursMinSecs}/></div>
      
      </div>
     <div className="row p-3 border"></div>  
      </div>
      <div className="col-2"> {  <Stack direction="row" spacing={0}> 
      <Avatar sx={{ width: 150, height: 115  }} variant="square"   src="/broken-image.jpg"/>
    ...
    <div className="row" >
      <div className="col-8 p-4" style={{ maxWidth: '100%', minHeight: '440px', overflow: 'auto'}} > </div>
    ...
    <div className="row p-2 border">
       ...
       <div className="col-7"></div>
        ...
        <div className="col-2 "><button type="button" className="btn  btn-outline-danger fs-6" onClick={() => navigate.push('/Ex-summary4')}>Skip Test</button></div>
    </div>
