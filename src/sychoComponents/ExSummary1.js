...
// countdown timer end
 ...
 export default function ExSummaryOne() {
...
return(
  ...
  <div className="container-fluid">
    ...
    <div className="row border">
      ...
      <div className="col-12 py-3" style={{ width: '100%', height: '500px', overflow: 'auto'}}>
    ...
    <h6>Test 2- Selective Attention Test / चयनात्मक ध्यान परीक्षण</h6><br />
    ...
    <div className="row px-1 bg-white border" style={{ position: 'fixed',bottom: '10px', width: '100%'}}>
      ...
      <div className="col-8 text-center"><button type="button" className="btn btn-outline-danger px-4 fs-6" onClick={() => navigate.push('/gs-test2')} size="small">Skip</button></div>
      <div className="col-2"></div>
      </div>
