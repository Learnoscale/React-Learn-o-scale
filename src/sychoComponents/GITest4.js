    ...
    <div className="row p-1 bg-dark text-white"><text>RRC WCR apptitude Test</text> </div>
      ...
      <div   className="row " >
        <div className="col-11">
          <div className="row p-2 bg-secondary text-center text-white"><h5>Group Instructions: Test 4 Information ordering test/निर्देशों के अनुसार कार्य करने की क्षमता का परीक्षण</h5></div>
          ...
          <div className="row px-1 bg-white border" style={{ position: 'fixed',bottom: '10px', width: '100%'}}>
           <div className="col-2"></div>
            ...
            <button type="button" className="btn btn-outline-danger px-4  fs-6" onClick={() => navigate.push('/section4')}>Skip</button></div>
            <div className="col-2"></div> 
          </div>
          </div>
